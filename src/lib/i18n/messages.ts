...
export type MessageKey =
  ...
  | 'examPrep.create.title' | 'examPrep.create.exam' | 'examPrep.create.date' | 'examPrep.create.purpose'
  | 'examPrep.create.programme' | 'examPrep.create.subject' | 'examPrep.create.optional'
  | 'examPrep.create.submit' | 'examPrep.create.submitting' | 'examPrep.create.unavailable' | 'examPrep.create.error'
  ...
  // CANON-V2-FINAL-HARDENING Section 6/8/9/10 -- distinct learner-facing
  // framing for the 4 canonical activities added after canonical_prove
  // (Prove itself gets real copy here too, replacing its old
  // quick_check-copy fallback).
  ...
  // CANON-V2-FINAL-HARDENING Section 6/9/10 -- RETAIN/TRANSFER/LEARN
  // next-step copy (previously these 3 stages rendered nothing at all
  // on the Results screen) + the Transfer-specific breakdown/diagnosis
  ...
  // CANON-R6-PERF-R2 Part 17/19 -- the focused Prove preparation
  // loading experience. Curated, static copy only -- never AI-generated.
  | 'quiz.provePreparingTitle' | 'quiz.provePreparingSubtitle'
  | 'quiz.provePreparingContractCount' | 'quiz.provePreparingContractIndependent'
  | 'quiz.provePreparingContractDifficulty' | 'quiz.provePreparingContractNoHints'
  | 'quiz.proveFocusTip1' | 'quiz.proveFocusTip2' | 'quiz.proveFocusTip3' | 'quiz.proveFocusTip4'
  ...
  | 'mathExpression.ariaLabel' | 'mathExpression.moreLabel' | 'mathExpression.voiceUnderstood'
  | 'mathExpression.voiceAcceptLabel' | 'mathExpression.voiceDiscardLabel' | 'mathExpression.voiceParseFailedMessage'
  | 'mathExpression.voiceRawTranscriptLabel'
  | 'response.instructionAnswerOnly' | 'response.instructionShowWork' | 'response.instructionJustify' | 'response.instructionExplain' | 'response.mathKeyboardLabel' | 'response.micLabel'
  ...
  | 'difficulty.label'
  | 'difficulty.workedLabel'
  | 'difficulty.of'
  | 'difficulty.autoAdjustExplanation'
  | 'difficulty.level1'
  | 'difficulty.level2'
  | 'difficulty.level3'
  | 'difficulty.level4'
...
const es: Messages = {
  ...
  'examPrep.create.title': 'Define el examen que quieres preparar', 'examPrep.create.exam': 'Examen', 'examPrep.create.date': 'Fecha del examen', 'examPrep.create.purpose': 'Objetivo', 'examPrep.create.programme': 'Programa', 'examPrep.create.subject': 'Materia de enfoque', 'examPrep.create.optional': 'opcional', 'examPrep.create.submit': 'Crear preparación', 'examPrep.create.submitting': 'Creando…', 'examPrep.create.unavailable': 'Todavía no hay exámenes publicados disponibles. Solicita al equipo académico que publique el catálogo del piloto.', 'examPrep.create.error': 'No se pudo crear tu preparación de examen.',
  ...
  'payment.status.suspended': 'Suspendido',
  ...
  'billing.statusSuspended': 'Tu suscripción está suspendida. Tu progreso e historial se conservan, pero la práctica paga no está disponible hasta reactivar.',
  ...
  'quiz.canonicalNextConsolidated': 'Has demostrado que entiendes este concepto, que puedes aplicarlo por tu cuenta, que se mantiene contigo con el tiempo y que puedes usarlo en situaciones nuevas. Concepto consolidado.',
  'quiz.canonicalNextRetain': 'Ya has demostrado que puedes hacerlo por tu cuenta. Ahora comprobaremos si se mantiene contigo con el tiempo.',
  'quiz.canonicalNextTransfer': 'Siguiente: aplica lo que sabes en situaciones nuevas.',
  'quiz.canonicalNextLearn': 'Repasemos juntos la idea principal antes de volver a intentarlo.',
  'quiz.transferResultTitle': 'Transferencia · Aplicar en situaciones nuevas',
  'quiz.transferChallengeNear': 'Aplicación cercana',
  ...
  'quiz.transferDiagnosticCriticalMisconception': 'Encontramos un malentendido importante que hay que corregir antes de continuar.',
  ...
  'quiz.provePreparingTitle': 'Preparando tu Prove',
  'quiz.provePreparingSubtitle': 'Se están preparando {count} preguntas independientes para este concepto.',
  'quiz.provePreparingContractCount': '{count} preguntas',
  'quiz.provePreparingContractIndependent': 'Independiente',
  'quiz.provePreparingContractDifficulty': 'Dificultad {range}',
  'quiz.provePreparingContractNoHints': 'Sin pistas',
  'quiz.proveFocusTip1': 'Lee la pregunta completa antes de elegir tu enfoque.',
  'quiz.proveFocusTip2': 'Trabaja de forma independiente: este paso mide lo que puedes hacer sin ayuda.',
  'quiz.proveFocusTip3': 'Si una pregunta no te resulta familiar, identifica primero el concepto subyacente.',
  'quiz.proveFocusTip4': 'La precisión importa más que la velocidad.',
  ...
  'quiz.modeCanonicalProve': 'Prove',
  'quiz.modeCanonicalProveDesc': 'Ahora demuéstralo por tu cuenta: sin pistas, sin ejemplos, evaluación independiente.',
  'quiz.modeCanonicalRetain': 'Retención',
  'quiz.modeCanonicalRetainDesc': 'Muestra qué recuerdas todavía -- de forma independiente, sin ayuda de IA.',
  'quiz.modeCanonicalTransfer': 'Transferencia',
  'quiz.modeCanonicalTransferDesc': 'Aplica lo que sabes en situaciones nuevas: una cercana, otra en un contexto distinto y un reto avanzado.',
  'quiz.modeCanonicalLearnCheck': 'Comprobación de comprensión',
  'quiz.modeCanonicalLearnCheckDesc': 'Vamos a comprobar que entiendes la idea principal -- puedes pedir ayuda si la necesitas.',
  'quiz.retainPreparingTitle': 'Preparando tu comprobación de retención...',
  'quiz.transferPreparingTitle': 'Preparando tus retos de transferencia...',
  'quiz.learnCheckPreparingTitle': 'Preparando tu comprobación de comprensión...',
  ...
  'mathExpression.ariaLabel': 'Editor de expresión matemática',
  'mathExpression.moreLabel': 'Más',
  'mathExpression.voiceUnderstood': 'StudyUS entendió:',
  'mathExpression.voiceAcceptLabel': 'Usar esta expresión',
  'mathExpression.voiceDiscardLabel': 'Descartar',
  'mathExpression.voiceParseFailedMessage': 'No pudimos convertir todo eso en matemáticas. Revísalo antes de continuar.',
  'mathExpression.voiceRawTranscriptLabel': 'Lo que escuchamos:',
  'response.instructionAnswerOnly': 'Escribe tu respuesta.',
  'response.instructionShowWork': 'Muestra tu procedimiento y tu respuesta final.',
  'response.instructionJustify': 'Da tu respuesta y explica por qué.',
  'response.instructionExplain': 'Explica tu razonamiento.',
  'response.mathKeyboardLabel': 'Insertar matemática',
  'response.micLabel': 'Responder por voz',
  ...
  'difficulty.workedLabel': 'Dificultad trabajada',
  'difficulty.of': 'de',
  'difficulty.autoAdjustExplanation': 'StudyUS ajusta automáticamente la dificultad según tu evidencia de aprendizaje.',
  'difficulty.level1': 'Inicial',
  'difficulty.level2': 'Básica',
  'difficulty.level3': 'Intermedia',
  'difficulty.level4': 'Alta',
  'difficulty.level5': 'Avanzada',
  ...
  'continuation.waitingBody': 'Por ahora no necesitas hacer nada más. StudyUS te avisará cuando sea momento de comprobar que aún lo recuerdas.',
...
const en: Messages = {
  ...
  'examPrep.create.title': 'Choose the exam you want to prepare for', 'examPrep.create.exam': 'Exam', 'examPrep.create.date': 'Exam date', 'examPrep.create.purpose': 'Goal', 'examPrep.create.programme': 'Programme', 'examPrep.create.subject': 'Subject focus', 'examPrep.create.optional': 'optional', 'examPrep.create.submit': 'Create preparation', 'examPrep.create.submitting': 'Creating…', 'examPrep.create.unavailable': 'No published exams are available yet. Ask the academic team to publish the pilot catalog.', 'examPrep.create.error': 'Could not create your exam preparation.',
  ...
  'billing.statusSuspended': 'Your subscription is suspended. Your progress and history are preserved, but paid practice is unavailable until you reactivate.',
  ...
  'quiz.canonicalNextConsolidated': "You've shown you understand this concept, can apply it on your own, it stays with you over time, and you can use it in new situations. Concept consolidated.",
  'quiz.canonicalNextRetain': "You've already shown you can do this on your own. Now we'll check whether it stays with you over time.",
  'quiz.canonicalNextTransfer': 'Next: apply what you know in new situations.',
  'quiz.canonicalNextLearn': "Let's go over the main idea together before trying again.",
  'quiz.transferResultTitle': 'Transfer · Apply in new situations',
  'quiz.transferChallengeNear': 'Nearby application',
  ...
  'quiz.transferDiagnosticCriticalMisconception': 'We found an important misunderstanding that needs to be corrected before continuing.',
  ...
  'quiz.provePreparingTitle': 'Preparing your Prove',
  'quiz.provePreparingSubtitle': '{count} independent questions are being prepared for this concept.',
  'quiz.provePreparingContractCount': '{count} questions',
  'quiz.provePreparingContractIndependent': 'Independent',
  'quiz.provePreparingContractDifficulty': 'Difficulty {range}',
  'quiz.provePreparingContractNoHints': 'No hints',
  'quiz.proveFocusTip1': 'Read the full question before choosing your approach.',
  'quiz.proveFocusTip2': "Work independently -- this step measures what you can do without help.",
  'quiz.proveFocusTip3': 'If a question looks unfamiliar, identify the underlying concept first.',
  'quiz.proveFocusTip4': 'Accuracy matters more than speed.',
  ...
  'quiz.modeCanonicalProve': 'Prove',
  'quiz.modeCanonicalProveDesc': 'Now prove you can do it on your own: no hints, no examples, independent assessment.',
  'quiz.modeCanonicalRetain': 'Retention',
  'quiz.modeCanonicalRetainDesc': 'Show what you still remember -- independently, with no AI help.',
  'quiz.modeCanonicalTransfer': 'Transfer',
  'quiz.modeCanonicalTransferDesc': 'Apply what you know in new situations: one nearby, one in a different context, and an advanced challenge.',
  'quiz.modeCanonicalLearnCheck': "Understanding check",
  'quiz.modeCanonicalLearnCheckDesc': "Let's check that you understand the main idea -- you can ask for help if you need it.",
  'quiz.retainPreparingTitle': 'Preparing your retention check...',
  'quiz.transferPreparingTitle': 'Preparing your transfer challenges...',
  'quiz.learnCheckPreparingTitle': 'Preparing your understanding check...',
  ...
  'mathExpression.ariaLabel': 'Math expression editor',
  'mathExpression.moreLabel': 'More',
  'mathExpression.voiceUnderstood': 'StudyUS understood:',
  'mathExpression.voiceAcceptLabel': 'Use this expression',
  'mathExpression.voiceDiscardLabel': 'Discard',
  'mathExpression.voiceParseFailedMessage': 'We couldn\'t convert all of that into math. Review it before continuing.',
  'mathExpression.voiceRawTranscriptLabel': 'What we heard:',
  'response.instructionAnswerOnly': 'Enter your answer.',
  'response.instructionShowWork': 'Show your work and final answer.',
  'response.instructionJustify': 'Give your answer and explain why.',
  'response.instructionExplain': 'Explain your reasoning.',
  'response.mathKeyboardLabel': 'Insert math',
  'response.micLabel': 'Answer by voice',
  ...
  'difficulty.workedLabel': 'Difficulty practiced',
  'difficulty.of': 'of',
  'difficulty.autoAdjustExplanation': 'StudyUS automatically adjusts difficulty based on your learning evidence.',
  'difficulty.level1': 'Initial',
  'difficulty.level2': 'Basic',
  'difficulty.level3': 'Intermediate',
  'difficulty.level4': 'High',
  'difficulty.level5': 'Advanced',
  ...
  'continuation.waitingBody': 'You don\'t need to do anything else right now. StudyUS will let you know when it\'s time to check that you still remember it.',
...
const de: Messages = {
  ...
  'examPrep.create.title': 'Wähle die Prüfung, auf die du dich vorbereiten möchtest', 'examPrep.create.exam': 'Prüfung', 'examPrep.create.date': 'Prüfungstermin', 'examPrep.create.purpose': 'Ziel', 'examPrep.create.programme': 'Programm', 'examPrep.create.subject': 'Fachlicher Schwerpunkt', 'examPrep.create.optional': 'optional', 'examPrep.create.submit': 'Vorbereitung erstellen', 'examPrep.create.submitting': 'Wird erstellt…', 'examPrep.create.unavailable': 'Noch sind keine veröffentlichten Prüfungen verfügbar. Bitte das akademische Team, den Pilotkatalog zu veröffentlichen.', 'examPrep.create.error': 'Die Prüfungsvorbereitung konnte nicht erstellt werden.',
  ...
  'payment.status.suspended': 'Ausgesetzt',
  ...
  'billing.statusSuspended': 'Dein Abonnement ist ausgesetzt. Dein Fortschritt und Verlauf bleiben erhalten, aber bezahltes Üben ist bis zur Reaktivierung nicht verfügbar.',
  ...
  'quiz.canonicalNextConsolidated': 'Du hast gezeigt, dass du dieses Konzept verstehst, es eigenständig anwenden kannst, es dir langfristig erhalten bleibt und du es in neuen Situationen nutzen kannst. Konzept gefestigt.',
  'quiz.canonicalNextRetain': 'Du hast bereits gezeigt, dass du es eigenständig kannst. Jetzt prüfen wir, ob es dir langfristig erhalten bleibt.',
  'quiz.canonicalNextTransfer': 'Weiter: Wende dein Wissen in neuen Situationen an.',
  'quiz.canonicalNextLearn': 'Lass uns die Kernidee gemeinsam wiederholen, bevor du es erneut versuchst.',
  'quiz.transferResultTitle': 'Transfer · In neuen Situationen anwenden',
  'quiz.transferChallengeNear': 'Naheliegende Anwendung',
  ...
  'quiz.transferDiagnosticCriticalMisconception': 'Wir haben ein wichtiges Missverständnis gefunden, das korrigiert werden muss, bevor es weitergeht.',
  ...
  'quiz.provePreparingTitle': 'Dein Prove wird vorbereitet',
  'quiz.provePreparingSubtitle': '{count} unabhängige Fragen werden für dieses Konzept vorbereitet.',
  'quiz.provePreparingContractCount': '{count} Fragen',
  'quiz.provePreparingContractIndependent': 'Eigenständig',
  'quiz.provePreparingContractDifficulty': 'Schwierigkeit {range}',
  'quiz.provePreparingContractNoHints': 'Keine Hinweise',
  'quiz.proveFocusTip1': 'Lies die ganze Frage, bevor du deinen Ansatz wählst.',
  'quiz.proveFocusTip2': 'Arbeite eigenständig -- dieser Schritt misst, was du ohne Hilfe kannst.',
  'quiz.proveFocusTip3': 'Wenn dir eine Frage unbekannt vorkommt, bestimme zuerst das zugrunde liegende Konzept.',
  'quiz.proveFocusTip4': 'Genauigkeit zählt mehr als Geschwindigkeit.',
  ...
  'quiz.modeCanonicalProve': 'Prove',
  'quiz.modeCanonicalProveDesc': 'Jetzt beweise, dass du es eigenständig kannst: keine Hinweise, keine Beispiele, eigenständige Prüfung.',
  'quiz.modeCanonicalRetain': 'Merkfähigkeit',
  'quiz.modeCanonicalRetainDesc': 'Zeig, was du dir noch merkst -- eigenständig, ohne KI-Hilfe.',
  'quiz.modeCanonicalTransfer': 'Transfer',
  'quiz.modeCanonicalTransferDesc': 'Wende dein Wissen in neuen Situationen an: eine naheliegende, eine in einem anderen Kontext und eine fortgeschrittene Herausforderung.',
  'quiz.modeCanonicalLearnCheck': 'Verständnisprüfung',
  'quiz.modeCanonicalLearnCheckDesc': 'Lass uns prüfen, ob du die Kernidee verstehst -- du kannst um Hilfe bitten, wenn du sie brauchst.',
  'quiz.retainPreparingTitle': 'Deine Merkfähigkeitsprüfung wird vorbereitet...',
  'quiz.transferPreparingTitle': 'Deine Transfer-Herausforderungen werden vorbereitet...',
  'quiz.learnCheckPreparingTitle': 'Deine Verständnisprüfung wird vorbereitet...',
  ...
  'mathExpression.ariaLabel': 'Editor für mathematische Ausdrücke',
  'mathExpression.moreLabel': 'Mehr',
  'mathExpression.voiceUnderstood': 'StudyUS hat verstanden:',
  'mathExpression.voiceAcceptLabel': 'Diesen Ausdruck verwenden',
  'mathExpression.voiceDiscardLabel': 'Verwerfen',
  'mathExpression.voiceParseFailedMessage': 'Wir konnten nicht alles davon in Mathematik umwandeln. Überprüfe es, bevor du fortfährst.',
  'mathExpression.voiceRawTranscriptLabel': 'Was wir gehört haben:',
  'response.instructionAnswerOnly': 'Gib deine Antwort ein.',
  'response.instructionShowWork': 'Zeige deinen Lösungsweg und die Endantwort.',
  'response.instructionJustify': 'Gib deine Antwort an und erkläre warum.',
  'response.instructionExplain': 'Erkläre deine Überlegung.',
  'response.mathKeyboardLabel': 'Mathematik einfügen',
  'response.micLabel': 'Per Sprache antworten',
  ...
  'difficulty.workedLabel': 'Bearbeitete Schwierigkeit',
  'difficulty.of': 'von',
  'difficulty.autoAdjustExplanation': 'StudyUS passt die Schwierigkeit automatisch an deine Lernnachweise an.',
  'difficulty.level1': 'Einstieg',
  'difficulty.level2': 'Grundlegend',
  'difficulty.level3': 'Mittel',
  'difficulty.level4': 'Hoch',
  'difficulty.level5': 'Fortgeschritten',
  ...
  'continuation.waitingBody': 'Im Moment musst du nichts weiter tun. StudyUS meldet sich, wenn es Zeit ist zu prüfen, ob du es noch weißt.',
...
const fr: Messages = {
  ...
  'examPrep.create.title': "Choisis l'examen que tu veux préparer", 'examPrep.create.exam': 'Examen', 'examPrep.create.date': "Date de l'examen", 'examPrep.create.purpose': 'Objectif', 'examPrep.create.programme': 'Programme', 'examPrep.create.subject': 'Matière ciblée', 'examPrep.create.optional': 'facultatif', 'examPrep.create.submit': 'Créer la préparation', 'examPrep.create.submitting': 'Création…', 'examPrep.create.unavailable': "Aucun examen publié n'est encore disponible. Demande à l'équipe académique de publier le catalogue pilote.", 'examPrep.create.error': "Impossible de créer la préparation à l'examen.",
  ...
  'payment.status.suspended': 'Suspendu',
  ...
  'billing.statusSuspended': 'Ton abonnement est suspendu. Ta progression et ton historique sont conservés, mais la pratique payante est indisponible jusqu\'à la réactivation.',
  ...
  'quiz.canonicalNextConsolidated': "Vous avez montré que vous comprenez ce concept, que vous pouvez l'appliquer seul, qu'il reste acquis dans le temps et que vous pouvez l'utiliser dans de nouvelles situations. Concept consolidé.",
  'quiz.canonicalNextRetain': "Vous avez déjà montré que vous pouvez le faire seul. Nous allons maintenant vérifier si cela reste acquis dans le temps.",
  'quiz.canonicalNextTransfer': 'Suivant : appliquez ce que vous savez dans de nouvelles situations.',
  'quiz.canonicalNextLearn': "Revoyons ensemble l'idée principale avant de réessayer.",
  'quiz.transferResultTitle': 'Transfert · Appliquer dans de nouvelles situations',
  'quiz.transferChallengeNear': 'Application proche',
  ...
  'quiz.transferDiagnosticCriticalMisconception': 'Nous avons trouvé une confusion importante à corriger avant de continuer.',
  ...
  'quiz.provePreparingTitle': 'Préparation de ton Prove',
  'quiz.provePreparingSubtitle': '{count} questions indépendantes sont en cours de préparation pour ce concept.',
  'quiz.provePreparingContractCount': '{count} questions',
  'quiz.provePreparingContractIndependent': 'Indépendant',
  'quiz.provePreparingContractDifficulty': 'Difficulté {range}',
  'quiz.provePreparingContractNoHints': 'Aucun indice',
  'quiz.proveFocusTip1': 'Lis toute la question avant de choisir ton approche.',
  'quiz.proveFocusTip2': "Travaille de manière indépendante -- cette étape mesure ce que tu sais faire sans aide.",
  'quiz.proveFocusTip3': "Si une question semble inconnue, identifie d'abord le concept sous-jacent.",
  'quiz.proveFocusTip4': 'La précision compte plus que la vitesse.',
  ...
  'quiz.modeCanonicalProve': 'Prove',
  'quiz.modeCanonicalProveDesc': 'Prouvez maintenant que vous pouvez le faire seul : aucun indice, aucun exemple, évaluation indépendante.',
  'quiz.modeCanonicalRetain': 'Rétention',
  'quiz.modeCanonicalRetainDesc': 'Montrez ce dont vous vous souvenez encore -- seul, sans aide de l\'IA.',
  'quiz.modeCanonicalTransfer': 'Transfert',
  'quiz.modeCanonicalTransferDesc': 'Appliquez ce que vous savez dans de nouvelles situations : une proche, une dans un contexte différent, et un défi avancé.',
  'quiz.modeCanonicalLearnCheck': 'Vérification de compréhension',
  'quiz.modeCanonicalLearnCheckDesc': "Vérifions que vous comprenez l'idée principale -- vous pouvez demander de l'aide si besoin.",
  'quiz.retainPreparingTitle': 'Préparation de votre vérification de rétention...',
  'quiz.transferPreparingTitle': 'Préparation de vos défis de transfert...',
  'quiz.learnCheckPreparingTitle': 'Préparation de votre vérification de compréhension...',
  ...
  'mathExpression.ariaLabel': 'Éditeur d\'expression mathématique',
  'mathExpression.moreLabel': 'Plus',
  'mathExpression.voiceUnderstood': 'StudyUS a compris :',
  'mathExpression.voiceAcceptLabel': 'Utiliser cette expression',
  'mathExpression.voiceDiscardLabel': 'Ignorer',
  'mathExpression.voiceParseFailedMessage': 'Nous n\'avons pas pu tout convertir en mathématiques. Vérifie avant de continuer.',
  'mathExpression.voiceRawTranscriptLabel': 'Ce que nous avons entendu :',
  'response.instructionAnswerOnly': 'Saisis ta réponse.',
  'response.instructionShowWork': 'Montre ta démarche et ta réponse finale.',
  'response.instructionJustify': 'Donne ta réponse et explique pourquoi.',
  'response.instructionExplain': 'Explique ton raisonnement.',
  'response.mathKeyboardLabel': 'Insérer des mathématiques',
  'response.micLabel': 'Répondre à voix haute',
  ...
  'difficulty.workedLabel': 'Difficulté travaillée',
  'difficulty.of': 'sur',
  'difficulty.autoAdjustExplanation': 'StudyUS ajuste automatiquement la difficulté selon tes preuves d\'apprentissage.',
  'difficulty.level1': 'Initiale',
  'difficulty.level2': 'De base',
  'difficulty.level3': 'Intermédiaire',
  'difficulty.level4': 'Élevée',
  'difficulty.level5': 'Avancée',
  ...
  'continuation.waitingBody': 'Pour le moment, tu n\'as rien d\'autre à faire. StudyUS te préviendra quand ce sera le moment de vérifier que tu t\'en souviens encore.',
...
const pt: Messages = {
  ...
  'examPrep.create.title': 'Escolha o exame que você quer preparar', 'examPrep.create.exam': 'Exame', 'examPrep.create.date': 'Data do exame', 'examPrep.create.purpose': 'Objetivo', 'examPrep.create.programme': 'Programa', 'examPrep.create.subject': 'Matéria de foco', 'examPrep.create.optional': 'opcional', 'examPrep.create.submit': 'Criar preparação', 'examPrep.create.submitting': 'Criando…', 'examPrep.create.unavailable': 'Ainda não há exames publicados disponíveis. Peça à equipe acadêmica para publicar o catálogo do piloto.', 'examPrep.create.error': 'Não foi possível criar sua preparação para o exame.',
  ...
  'payment.status.past_due': 'Atrasado',
  'payment.status.canceled': 'Cancelado',
  'payment.status.suspended': 'Suspenso',
  ...
  'billing.statusSuspended': 'Sua assinatura está suspensa. Seu progresso e histórico são preservados, mas a prática paga fica indisponível até a reativação.',
  ...
  'quiz.canonicalNextConsolidated': 'Você mostrou que entende este conceito, que consegue aplicá-lo sozinho, que ele permanece com você ao longo do tempo e que consegue usá-lo em situações novas. Conceito consolidado.',
  'quiz.canonicalNextRetain': 'Você já mostrou que consegue fazer isso sozinho. Agora vamos verificar se isso permanece com você ao longo do tempo.',
  'quiz.canonicalNextTransfer': 'Próximo: aplique o que você sabe em situações novas.',
  'quiz.canonicalNextLearn': 'Vamos revisar juntos a ideia principal antes de tentar novamente.',
  'quiz.transferResultTitle': 'Transferência · Aplicar em situações novas',
  'quiz.transferChallengeNear': 'Aplicação próxima',
  ...
  'quiz.transferDiagnosticCriticalMisconception': 'Encontramos um mal-entendido importante que precisa ser corrigido antes de continuar.',
  ...
  'quiz.provePreparingTitle': 'Preparando seu Prove',
  'quiz.provePreparingSubtitle': '{count} perguntas independentes estão sendo preparadas para este conceito.',
  'quiz.provePreparingContractCount': '{count} perguntas',
  'quiz.provePreparingContractIndependent': 'Independente',
  'quiz.provePreparingContractDifficulty': 'Dificuldade {range}',
  'quiz.provePreparingContractNoHints': 'Sem dicas',
  'quiz.proveFocusTip1': 'Leia a pergunta completa antes de escolher sua abordagem.',
  'quiz.proveFocusTip2': 'Trabalhe de forma independente -- esta etapa mede o que você consegue fazer sem ajuda.',
  'quiz.proveFocusTip3': 'Se uma pergunta parecer desconhecida, identifique primeiro o conceito subjacente.',
  'quiz.proveFocusTip4': 'A precisão importa mais do que a velocidade.',
  ...
  'quiz.modeCanonicalProve': 'Prove',
  'quiz.modeCanonicalProveDesc': 'Agora prove que você consegue fazer isso sozinho: sem dicas, sem exemplos, avaliação independente.',
  'quiz.modeCanonicalRetain': 'Retenção',
  'quiz.modeCanonicalRetainDesc': 'Mostre o que você ainda lembra -- de forma independente, sem ajuda de IA.',
  'quiz.modeCanonicalTransfer': 'Transferência',
  'quiz.modeCanonicalTransferDesc': 'Aplique o que você sabe em situações novas: uma próxima, uma em contexto diferente e um desafio avançado.',
  'quiz.modeCanonicalLearnCheck': 'Verificação de compreensão',
  'quiz.modeCanonicalLearnCheckDesc': 'Vamos verificar se você entende a ideia principal -- você pode pedir ajuda se precisar.',
  'quiz.retainPreparingTitle': 'Preparando sua verificação de retenção...',
  'quiz.transferPreparingTitle': 'Preparando seus desafios de transferência...',
  'quiz.learnCheckPreparingTitle': 'Preparando sua verificação de compreensão...',
  ...
  'mathToolbar.infinity': 'Infinito',
  'mathToolbar.partial': 'Derivada parcial',
  'mathExpression.ariaLabel': 'Editor de expressão matemática',
  'mathExpression.moreLabel': 'Mais',
  'mathExpression.voiceUnderstood': 'A StudyUS entendeu:',
  'mathExpression.voiceAcceptLabel': 'Usar esta expressão',
  'mathExpression.voiceDiscardLabel': 'Descartar',
  'mathExpression.voiceParseFailedMessage': 'Não conseguimos converter tudo isso em matemática. Revise antes de continuar.',
  'mathExpression.voiceRawTranscriptLabel': 'O que ouvimos:',
  'response.instructionAnswerOnly': 'Digite sua resposta.',
  'response.instructionShowWork': 'Mostre seu processo e sua resposta final.',
  'response.instructionJustify': 'Dê sua resposta e explique por quê.',
  'response.instructionExplain': 'Explique seu raciocínio.',
  'response.mathKeyboardLabel': 'Inserir matemática',
  'response.micLabel': 'Responder por voz',
  ...
  'difficulty.label': 'Dificuldade',
  'difficulty.workedLabel': 'Dificuldade trabalhada',
  'difficulty.of': 'de',
  'difficulty.autoAdjustExplanation': 'O StudyUS ajusta automaticamente a dificuldade com base na sua evidência de aprendizagem.',
  'difficulty.level1': 'Inicial',
  'difficulty.level2': 'Básica',
  'difficulty.level3': 'Intermediária',
  'difficulty.level4': 'Alta',
  'difficulty.level5': 'Avançada',
  ...
  'continuation.waitingBody': 'Por enquanto você não precisa fazer mais nada. O StudyUS vai avisar quando for a hora de verificar se você ainda se lembra disso.',
